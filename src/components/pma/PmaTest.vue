<template>
    <div class="pma-test-container">
      ...
      <div class="score-display">
        <div>Circle Time - Blue: {{ scores.tracking.blueTime.toFixed(1) }}s, Red: {{ scores.tracking.redTime.toFixed(1) }}s</div>
        <div>Dot Time - Green: {{ scores.tracking.greenTime.toFixed(1) }}s, Red: {{ scores.tracking.dotRedTime.toFixed(1) }}s</div>
      </div>
