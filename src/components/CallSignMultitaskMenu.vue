<template>
  <div class="battery-test-detail">
    <div class="info-box">
      <h1>Multitasking dengan Callsgin</h1>
...
<script>
export default {
  name: 'CallSignMultitaskMenu',
  data() {
    return {
      tests: [
        { id: 1, name: 'Test 1', link: '/battery-test-2' },
        { id: 2, name: 'Test 2', link: '/battery-test-2' },
        { id: 3, name: 'Test 3', link: '/battery-test-2' }
